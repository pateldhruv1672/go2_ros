...
def generate_launch_description():
    return LaunchDescription([
        ...
        DeclareLaunchArgument('auto_save_interval_sec', default_value='10.0'),
        ...
        DeclareLaunchArgument('vlm_timeout_sec', default_value='45.0'),
        DeclareLaunchArgument('vlm_fail_fast_on_start', default_value='false'),
        DeclareLaunchArgument('vlm_shutdown_wait_sec', default_value='20.0'),
        DeclareLaunchArgument('auto_save_target_samples', default_value='0'),
        DeclareLaunchArgument('auto_save_allow_repeat_samples', default_value='false'),
        DeclareLaunchArgument('auto_save_min_distance_m', default_value='1.0'),
