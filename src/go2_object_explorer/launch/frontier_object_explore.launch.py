...
def generate_launch_description():
    return LaunchDescription(
        [
            ...
            DeclareLaunchArgument("cmd_vel_topic", default_value="/cmd_vel_omi"),
            ...
            DeclareLaunchArgument("search_spin_speed", default_value="0.45"),
            DeclareLaunchArgument("full_spin_angle_rad", default_value="6.20"),
            DeclareLaunchArgument("local_scan_angle_rad", default_value="2.10"),
            DeclareLaunchArgument("full_spin_timeout_sec", default_value="20.0"),
            DeclareLaunchArgument("spin_settle_sec", default_value="0.75"),
                ...
                parameters=[
                    {
                        ...
                        "search_spin_speed": LaunchConfiguration("search_spin_speed"),
                        "full_spin_angle_rad": LaunchConfiguration("full_spin_angle_rad"),
                        "local_scan_angle_rad": LaunchConfiguration("local_scan_angle_rad"),
                        "full_spin_timeout_sec": LaunchConfiguration("full_spin_timeout_sec"),
                        "spin_settle_sec": LaunchConfiguration("spin_settle_sec"),
