...
class VLMClient:
    """Small OpenRouter/Gemini-compatible VLM client with offline fallback.
    ...
    def __init__(self, provider: str = "offline", model: str = "google/gemini-2.5-flash", api_key: str = "", base_url: str = ""):
